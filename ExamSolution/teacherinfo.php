...
$sql = "select id,fullname,uname,pword from tbl_teacher where id='". $_SESSION['id'] ."'";
  ...
  <body>
    ...
    <div class="container-fluid">
	  ...
	  <div class="col-sm-5 col-sm-offset-1  main">
        <h2>ข้อมูลส่วนตัว</h2>              
<form id="frm" class="form-horizontal" action="do_teacherinfo.php" method="post">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-3 col-sm-10">
	  ...
	  <a type="button" class="btn btn-default" href="dashboard_teacher.php" role="button">ย้อนกลับ</a>
    </div>
  </div>
</form>

<h2>แก้ไขรหัสผ่าน</h2>              
<form id="frm2" class="form-horizontal" action="do_teacherinfo.php" method="post">
  <input type="hidden" class="form-control" name="id" id="id"  value="<?=$data['id'];?>" />
