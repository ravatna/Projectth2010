...
public class DamageAdapter extends BaseAdapter {
    ...
    private ArrayList<DamageItem> mapArrayList ;

    public ImageView imageLoader;

    public DamageAdapter(Context _ctx , ArrayList<DamageItem> mapList) {
        ctx = _ctx;
    ...
    public DamageItem getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View vi=convertView;
        if(convertView==null)
            vi = inflater.inflate(R.layout._item_damage, null);
            final DamageItem item= mapArrayList.get(position);
//
                        ...
                        .setPositiveButton("ใช่",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog,
                                        ...
                                        DamageAdapter.this.notifyDataSetChanged();
