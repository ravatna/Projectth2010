...
String mStatusJob="";
    ...
    public DamageItem(int id, String mKTCode, String mClaimCode, String mPName, String mCarBrand, String mLicensePlate, String mAccidentPlace, String mTimeAcceptCase, String mStatusJob) {
        this.id = id;
