...
<html lang="th">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-3 col-md-2 sidebar"  style="background-color:black !important;padding-left:0px !important;padding-right:0px !important;  width:320px !important;">
                    <div>
                        <?php
                        $sql = "SELECT id,exam_id,exam_id,question,q_picture,choise_1,choise_2,choise_3,choise_4,answer_choise,answer_description,created_date FROM tbl_exam_detail where (exam_id  ='". $_SESSION['exam_id'] ."');";
    ...
    float: left;
    width: 85%;
	margin-left:5px;" ><?=$a['choise_1'];?></span>
                                            </a>
                                        </div>
                                        <?php
                                        }
    ...
    float: left;
    width: 85%;
	margin-left:5px;" ><?=$a['choise_2'];?></span>
                                            </a>
                                        </div>
                                        <?php
                                        }
...
<?php
    ...
    float: left;
    width: 85%;
	margin-left:5px;" ><?=$a['choise_5'];?></span>
                                            </a>
                                        </div>
                                        <?php
                                        }
