...
CREATE TABLE `tbl_do_exam_detail` (
  `do_exam_id` int(10) unsigned DEFAULT NULL,
  `exam_no` int(10) unsigned DEFAULT NULL,
  `answer_no` varchar(5) CHARACTER SET latin1 DEFAULT NULL,
  `currect_no` varchar(5) CHARACTER SET latin1 DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `do_time` int(10) unsigned DEFAULT NULL,
  `my_desc_answer` text,
  `is_desc_answer` char(1) DEFAULT NULL
