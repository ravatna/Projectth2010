...
--
-- Table structure for table `t_document_flow`
--

DROP TABLE IF EXISTS `t_document_flow`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_document_flow` (
...
--
-- Dumping data for table `t_document_flow`
--

LOCK TABLES `t_document_flow` WRITE;
/*!40000 ALTER TABLE `t_document_flow` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_document_flow` ENABLE KEYS */;
UNLOCK TABLES;
