...
DROP TABLE IF EXISTS `tb_borrow_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_borrow_status` (
  `id` int(3) NOT NULL,
...
LOCK TABLES `tb_borrow_status` WRITE;
/*!40000 ALTER TABLE `tb_borrow_status` DISABLE KEYS */;
INSERT INTO `tb_borrow_status` VALUES (1,'ยืม'),(2,'คืน');
/*!40000 ALTER TABLE `tb_borrow_status` ENABLE KEYS */;
UNLOCK TABLES;
