...
DROP TABLE IF EXISTS `tb_borrow_dtl`;
...
--
-- Dumping data for table `tb_borrow_dtl`
--

LOCK TABLES `tb_borrow_dtl` WRITE;
/*!40000 ALTER TABLE `tb_borrow_dtl` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_borrow_dtl` ENABLE KEYS */;
UNLOCK TABLES;
