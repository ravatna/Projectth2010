...
CREATE TABLE `tb_user` (
  ...
  `is_librarian` tinyint(1) DEFAULT NULL,
  `user_id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`user_id`,`identification`)
...
INSERT INTO `tb_user` VALUES ('admin','มนัสวินs','แสนคำs',21100,3,'','','00000000s','admin','111111111111',1,1),('123456','r','bo',NULL,1,NULL,NULL,'0000000000','123456','123456',NULL,6);
