...
<a class="btn btn-md btn-primary" href="admin_manage_book.php"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;ย้อนกลับ</a>
<hr style="margin-top:5px; margin-bottom:5px;" />
<div class="panel panel-primary">
                        <div class="panel-heading">
                            ฟอร์มจัด ลิงค์วารสารภายนอก
                        </div>
                        <div class="panel-body">
                            <!-- form manage book is here -->
                            <?php include_once("_journal_ext_form.php"); ?>
                        </div>
