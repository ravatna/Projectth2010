<div class="row">
<div class="col-md-8">
    <a class="btn btn-lg btn-primary" href="admin_update_book.php"><span class="glyphicon glyphicon-plus"></span> เพิ่มรายการ</a>
...
<table width="100%" class="table table-striped table-bordered table-hover" style="margin-top:10px;">
            ...
            <tbody>
                ...
                $statement = "tb_book  where is_ebook='". $_GET['is_ebook']."' order by category_id asc";
                ...
                while ($data = mysql_fetch_array($query)) {
                    ...
                    <tr style="cursor:pointer;" >
                        ...
                        <td align='center'>
                            <a class="btn btn-sm btn-primary" href="admin_update_book.php?book_id=<?= $data['book_id']; ?>"><span class="glyphicon glyphicon-pencil"></a>
                            </td>
                        <td align='center'>
                            <a class="btn btn-sm btn-danger" href="admin_update_book_del.php?book_id=<?= $data['book_id']; ?>"><span class="glyphicon glyphicon-trash"></a>
                            </td>
                    </tr>
                    <?PHP
                }
